...
// حالة ال سيفي في طلباتي فحص 
اللغة العربية في السيفي
 لما ارفع CV 
ما بياخذ البيانات من المعلومات اللي حطيتها

الغاء تعليمات ال ai عند تحسين ال Cv
عند الانتهاء من ال Cv لعودة للصفحة الرئيسية 
حالة الزظيفة  عند الشركة واليوزر تصليح

شات بوت في الجوب سيكر
يجاوب على اسئلته

ارسال سؤال للادمن من قبل ال job seeker
